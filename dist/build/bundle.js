...
var app = (function () {
    ...
    var Common;
    (function (Common) {
        function createBox(scene, { name, height = 1, width = 1, pos = [0, 0, 0], physics = null }) {
            ...
            if (physics) {
                ...
                box.physicsImpostor = new BABYLON.PhysicsImpostor(box, type, physics, scene);
            }
            return box;
        }
        Common.createBox = createBox;
        function createSphere(scene, { name, diameter = 1, pos = [0, 0, 0], physics = null }) {
            ...
            if (physics) {
                ...
                sphere.physicsImpostor = new BABYLON.PhysicsImpostor(sphere, type, physics, scene);
            }
            return sphere;
        }
        Common.createSphere = createSphere;
    })(Common || (Common = {}));
    var Common$1 = Common;
    ...
    */
    ...
    class TestScene extends BABYLON.Scene {
        ...
        load() {
            ...
            this.enablePhysics(this.gravity, new BABYLON.AmmoJSPlugin());
            Common$1.createBox(this, {
                name: "box1",
                physics: {
                    mass: 1.0,
                }
            ...
            let light = new BABYLON.HemisphericLight("hemispheric light 1", new BABYLON.Vector3(1, 1, 0), this);
            var light2 = new BABYLON.DirectionalLight("directional light 1", new BABYLON.Vector3(0, -0.5, -1.0), this);
            ...
            let sphere = Common$1.createSphere(this, {
                name: "sphere",
                diameter: 2,
                physics: {
    ...
    /* src\BabylonJSLoader.svelte generated by Svelte v3.24.0 */
    ...
    const scriptLoadPromise = (async () => {
    	let p1 = BABYLON_SCRIPT.map(src => new Promise(res => injectScript(src, res)));
    	let p2 = BABYLON_DEPENDENT_SCRIPT.map(src => new Promise(res => injectScript(src, res)));
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 26, 2, 620);
    			attr_dev(h1, "class", "svelte-w6s1zu");
    			add_location(h1, file, 27, 2, 677);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 28, 17, 717);
    			add_location(p, file, 28, 4, 704);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 19, 0, 438);
    		},
