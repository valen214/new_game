    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 26, 2, 608);
    			attr_dev(h1, "class", "svelte-w6s1zu");
    			add_location(h1, file, 27, 2, 665);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 28, 17, 705);
    			add_location(p, file, 28, 4, 692);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 19, 0, 426);
    		},
